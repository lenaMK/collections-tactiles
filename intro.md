...
choix d’offrir un accès en données ouvertes:

- créé d’autres opportunités,  autres imaginaires
- autres acteurs que les institutions elle-mêmes, autre regard sur les collections
- littératie numérique 
- limitations de l’espace numérique

traduction dans un espace / accès physique 

- beyond vision, approche multisensorielle
